        ...
        html.Div(
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        html.Img(src=app.get_asset_url("airbnb_logo.png"), style={"height": "55px"}),
                        html.Img(src=app.get_asset_url("london_flag.png"), style={"height": "45px"}),
                        html.Img(src=app.get_asset_url("bnb_collage.webp"), style={"height": "55px", "borderRadius": "4px"}),
                    ],
                ),
                ...
                html.Div(
                    ...
                    children=[
                        html.Div(style={"flex": "2", **CARD}, children=[dcc.Graph(id="price-distance")]),
                        html.Div(style={"flex": "1", **CARD}, children=[dcc.Graph(id="avg-price-distance")]),
                    ],
                ),
                ...
                html.Div(
                    style={"display": "flex", "gap": "15px"},
                    children=[
                        html.Div(style={"flex": "2", **CARD}, children=[dcc.Graph(id="attr-price")]),
                        html.Div(style={"flex": "1", **CARD}, children=[dcc.Graph(id="box-distance")]),
                    ],
                ),
                ...
                # HISTOGRAM
                html.Div(style={**CARD}, children=[dcc.Graph(id="price-hist")]),
